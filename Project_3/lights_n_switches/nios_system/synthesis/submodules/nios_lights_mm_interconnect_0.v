// nios_lights_mm_interconnect_0.v

// This file was auto-generated from altera_mm_interconnect_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.1 186 at 2016.02.03.19:30:00

`timescale 1 ps / 1 ps
module nios_lights_mm_interconnect_0 (
	...
	wire  [89:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_data_master_agent:rp_data
	...
	wire  [89:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_instruction_master_agent:rp_data
	...
	wire  [90:0] cpu_jtag_debug_module_agent_rf_source_data;                                // cpu_jtag_debug_module_agent:rf_source_data -> cpu_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [90:0] cpu_jtag_debug_module_agent_rsp_fifo_out_data;                             // cpu_jtag_debug_module_agent_rsp_fifo:out_data -> cpu_jtag_debug_module_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> cpu_jtag_debug_module_agent:cp_valid
	wire  [89:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> cpu_jtag_debug_module_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // cpu_jtag_debug_module_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> cpu_jtag_debug_module_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> cpu_jtag_debug_module_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> cpu_jtag_debug_module_agent:cp_endofpacket
	...
	wire  [13:0] onchip_s1_agent_m0_address;                                                // onchip_s1_agent:m0_address -> onchip_s1_translator:uav_address
	...
	wire  [90:0] onchip_s1_agent_rf_source_data;                                            // onchip_s1_agent:rf_source_data -> onchip_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] onchip_s1_agent_rsp_fifo_out_data;                                         // onchip_s1_agent_rsp_fifo:out_data -> onchip_s1_agent:rf_sink_data
	...
	wire         onchip_s1_agent_rdata_fifo_src_valid;                                      // onchip_s1_agent:rdata_fifo_src_valid -> onchip_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] onchip_s1_agent_rdata_fifo_src_data;                                       // onchip_s1_agent:rdata_fifo_src_data -> onchip_s1_agent:rdata_fifo_sink_data
	wire         onchip_s1_agent_rdata_fifo_src_ready;                                      // onchip_s1_agent:rdata_fifo_sink_ready -> onchip_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> onchip_s1_agent:cp_valid
	wire  [89:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // onchip_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> onchip_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> onchip_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> onchip_s1_agent:cp_endofpacket
	...
	wire  [89:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> switches_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // switches_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> switches_s1_agent:cp_channel
	...
	wire  [89:0] cpu_data_master_agent_cp_data;                                             // cpu_data_master_agent:cp_data -> router:sink_data
	...
	wire  [89:0] cpu_instruction_master_agent_cp_data;                                      // cpu_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [89:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                 // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire         cpu_jtag_debug_module_agent_rp_valid;                                      // cpu_jtag_debug_module_agent:rp_valid -> router_003:sink_valid
	wire  [89:0] cpu_jtag_debug_module_agent_rp_data;                                       // cpu_jtag_debug_module_agent:rp_data -> router_003:sink_data
	wire         cpu_jtag_debug_module_agent_rp_ready;                                      // router_003:sink_ready -> cpu_jtag_debug_module_agent:rp_ready
	wire         cpu_jtag_debug_module_agent_rp_startofpacket;                              // cpu_jtag_debug_module_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         cpu_jtag_debug_module_agent_rp_endofpacket;                                // cpu_jtag_debug_module_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         onchip_s1_agent_rp_valid;                                                  // onchip_s1_agent:rp_valid -> router_004:sink_valid
	wire  [89:0] onchip_s1_agent_rp_data;                                                   // onchip_s1_agent:rp_data -> router_004:sink_data
	wire         onchip_s1_agent_rp_ready;                                                  // router_004:sink_ready -> onchip_s1_agent:rp_ready
	wire         onchip_s1_agent_rp_startofpacket;                                          // onchip_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         onchip_s1_agent_rp_endofpacket;                                            // onchip_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [89:0] switches_s1_agent_rp_data;                                                 // switches_s1_agent:rp_data -> router_006:sink_data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (onchip_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (onchip_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (onchip_s1_agent_rdata_fifo_src_data),        //                .data
	...
	nios_lights_mm_interconnect_0_router router (
	...
	nios_lights_mm_interconnect_0_router_001 router_001 (
	...
	nios_lights_mm_interconnect_0_router_002 router_002 (
	...
	nios_lights_mm_interconnect_0_router_003 router_003 (
	...
	nios_lights_mm_interconnect_0_router_003 router_004 (
	...
	nios_lights_mm_interconnect_0_router_002 router_005 (
	...
	nios_lights_mm_interconnect_0_router_002 router_006 (
	...
	nios_lights_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_lights_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
